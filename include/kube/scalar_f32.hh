...
#ifndef KUBE_SCALAR_F32_HH
#define KUBE_SCALAR_F32_HH
...
constexpr auto min() noexcept
    -> f32 { return {std::numeric_limits<typename f32::native_type>::min()}; }

template <>
constexpr auto max() noexcept
    -> f32 { return {std::numeric_limits<typename f32::native_type>::max()}; }

template <>
constexpr auto min(f32 a, f32 b) noexcept
    -> f32 { return a < b ? a : b; }

template <>
constexpr auto max(f32 a, f32 b) noexcept
    -> f32 { return a > b ? a : b; }
