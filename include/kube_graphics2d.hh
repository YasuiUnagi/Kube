...
namespace kube {
    ...
    struct graphics2d {
        ...
        void use_color4d(f64 r, f64 g, f64 b, f64 a) noexcept {
            return _kuse_color4d_f64(this, r.native, g.native, b.native, a.native);
        }

        void use_color4d(f32 r, f32 g, f32 b, f32 a) noexcept {
            return _kuse_color4d_f32(this, r.native, g.native, b.native, a.native);
        }
        ...
        void use_color3d(f64 r, f64 g, f64 b) noexcept {
            return _kuse_color3d_f64(this, r.native, g.native, b.native);    
        }

        void use_color3d(f32 r, f32 g, f32 b) noexcept {
            return _kuse_color3d_f32(this, r.native, g.native, b.native);
        }
        ...
        void draw_line2d(f64 x1, f64 y1, f64 x2, f64 y2) noexcept {
            return _kdraw_line2d_f64(this, x1.native, y1.native, x2.native, y2.native);
        }

        void draw_line2d(f32 x1, f32 y1, f32 x2, f32 y2) noexcept {
            return _kdraw_line2d_f32(this, x1.native, y1.native, x2.native, y2.native);
        }
        ...
        void draw_box2d(f64 x1, f64 y1, f64 x2, f64 y2) noexcept {
            return _kdraw_box2d_f64(this, x1.native, y1.native, x2.native, y2.native);
        }
